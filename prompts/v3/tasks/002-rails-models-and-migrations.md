...
FactoryBot.define do
  factory :pipeline_step do
    ...
    trait :whatsapp_agent     do; agent_type { "whatsapp_agent" };     config { { "to" => "+15550193456" } }; end          # executor reads "to"
    trait :whatsapp_group_send do; agent_type { "whatsapp_group_send" }; config { { "group_jid" => "1234567890@g.us" } }; end  # executor reads "group_jid"
